...
public:
    ...
    void setupUi(QDialog *SaveAsImageDialog)
    {
        ...
        SaveAsImageDialog->resize(337, 231);
        ...
        drawTileGrid->setObjectName(QString::fromUtf8("drawTileGrid"));
    ...
    void retranslateUi(QDialog *SaveAsImageDialog)
    {
        ...
        drawTileGrid->setText(QApplication::translate("SaveAsImageDialog", "&Draw tile grid", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
