    ...
    , mDocumentManager(DocumentManager::instance())
{
	...
	createPathTool   * pCreatepathtool=new createPathTool(this); 
	...
	connect(mTilesetDock, SIGNAL(currentTileChanged(Tile*)),
		pCreatepathtool, SLOT(setTile(Tile*)));
	...
	toolManager->registerTool(pCreatepathtool);
	toolManager->registerTool(new pathPointSelectTool(this));
